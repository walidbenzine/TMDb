 ...
 */
class FavoriteMovieFragment : Fragment(), OnMovieClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val v= inflater.inflate(R.layout.fragment_favorite_movie, container, false)
        val movieFavRecyclerView = v.findViewById<RecyclerView>(R.id.favorite_movie_recycler_view)

        movieFavRecyclerView.apply {
            layoutManager = LinearLayoutManager(this.context, LinearLayoutManager.VERTICAL, false)
            adapter = MovieAdapter(movies , this@FavoriteMovieFragment)
        }
