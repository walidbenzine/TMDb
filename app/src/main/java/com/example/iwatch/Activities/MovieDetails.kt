    ...
    class SectionsPagerAdapter(fm: FragmentManager) : FragmentPagerAdapter(fm) {
        ...
        override fun getItem(position: Int): Fragment {
            return when (position){
                0 -> MovieDetailsFragment.newInstance(PostActor("https://scirusiwatch.herokuapp.com/getAct/"+movie?.id.toString()), PostFilm("https://scirusiwatch.herokuapp.com/getFilmLie/"+movie?.id.toString()))
